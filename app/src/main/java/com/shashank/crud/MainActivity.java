        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(Uid)){
                    uid.setError("UID obbligatorio");
                    valid = false;
                }else {
                    valid = true;

                    if(TextUtils.isEmpty(Name)){
                        name.setError("Nome obbligatorio");
                        valid = false;
                    }else {
                        valid = true;

                        if(TextUtils.isEmpty(Address)){
                            address.setError("Indirizzo obbligatorio");
                            valid = false;
                        }else {
                            valid = true;

                            if(TextUtils.isEmpty(Phone)){
                                phone.setError("Numero obbligatorio");
                                valid = false;
                            }else {
                                valid = true;
                            }
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_ADD, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try{
                                ...
                                if(jsonObject.getString("message").equals("Aggiunto con successo")){
