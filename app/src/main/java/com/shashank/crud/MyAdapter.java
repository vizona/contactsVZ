    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                final CharSequence[] dialogitem = {"Visualizza","Modifica","Elimina"};
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            ...
                            case 2 :
                                ...
                                builderDel.setMessage("Sicuro di voler eliminare?");
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_DELETE, new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                dialog.hide();
                                                dialog.dismiss();
                                                Toast.makeText(view.getContext(),"Cancellazione effettuata con successo "+ listItem.getName(),Toast.LENGTH_LONG).show();
                                ...
                                builderDel.setNegativeButton("Elimina", new DialogInterface.OnClickListener() {
                                    @Override
